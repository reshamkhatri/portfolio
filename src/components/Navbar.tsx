...
export function Navbar() {
    ...
    return (
        <motion.nav
            ...
            className={`fixed top-4 md:top-6 left-1/2 -translate-x-1/2 w-[95%] max-w-5xl z-50 px-6 py-3 rounded-2xl transition-all duration-500 ${scrolled
