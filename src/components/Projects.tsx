...
export function Projects() {
    ...
    // Rotate 360 degrees over the scroll of the section
    ...
    return (
        <section
            id="projects"
            ref={containerRef}
            className="py-32 px-4 md:px-6 relative bg-[#0a0a0a] z-10 overflow-hidden"
        >
            {/* Background Glow */}
            ...
            <div className="max-w-7xl mx-auto">
                                ...
                                >
                                    <div className="w-full h-full bg-black/60 backdrop-blur-xl border border-white/10 rounded-2xl overflow-hidden group hover:border-orange-500/50 transition-all duration-500 shadow-2xl">
                                        ...
                                        <div className="absolute bottom-0 left-0 right-0 p-6">
                                            ...
                                            <p className="text-orange-500/80 text-xs font-semibold uppercase tracking-wider">{project.caption}</p>
                                        </div>
                                    </div>
                                </motion.div>
                            );
                ...
                <div className="flex justify-center mt-20">
                    <Link
                        to="/projects"
                        className="group relative px-8 py-4 bg-white/5 backdrop-blur-sm border border-white/10 rounded-full overflow-hidden transition-all hover:border-orange-500/50 flex items-center gap-3"
                    >
